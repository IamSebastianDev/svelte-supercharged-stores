...
-   clone the repository by running `git clone https://github.com/IamSebastianDev/svelte-supercharged-stores.git .` in your terminal or shell to clone the repo into the current directory.
